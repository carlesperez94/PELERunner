...
def create_template(pdb, gridres, out_temp, out_rot):
   mae_file = convert_mae(pdb)
   plop.main(mae_file, out_temp=out_temp, out_rot=out_rot,
             gridres=gridres)
   os.remove(mae_file)
...
def arg_parse():
  ...
  parser.add_argument("out_temp", type=str, help="Folder to store the template")
  parser.add_argument("out_rot", type=str, help="Folder to store the rotamers lib.")
  args = parser.parse_args()
  return args.pdb, args.gridres, args.out_temp, args.out_rot


if __name__ == '__main__':
    pdb, gridres, out_temp, out_rot = arg_parse()
    create_template(pdb, gridres, out_temp, out_rot)
